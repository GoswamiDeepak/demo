...
<div class="header" id="topheader">	
	<nav class="navbar navbar-expand-lg">
 		<div class="container">
  			<a class="navbar-brand text-white font-weight-bold" href="#">DG<span class="text-danger">@media</span></a>
	 		...
	 		<div class="col-lg-6 col-10 offset-1 offset-lg-0">
	 			...
	 			<div class="names my-3">
	 				...
	 				<div class="progress w-75">
	 					...
	 					<div class="progress-bar progress-bar-striped progress-bar-animated bg-secondary" style="width:90%">90%</div>
	 				</div>	
	 			</div>
	 			...
	 			<div class="names my-3">
	 				...
	 				<div class="progress w-75">
	 					...
	 					<div class="progress-bar progress-bar-striped progress-bar-animated bg-danger" style="width:68%">68%</div>
	 				</div>
	 			</div>
	 		</div>

	 		<div class="col-lg-6 col-12 servicediv">
	 			<div class="row">
...
<section class="project-work">
	 <div class="container headings text-center">
	 	<p class="text-center font-weight-bold text-uppercase">More than 2000 Websites has been created</p>
...
<section class="pricing" id="pricingdiv">
	 <div class="container headings text-center">
	 	<h1 class="text-center font-weight-bold text-uppercase text-white text-danger">Our best Pricing</h1>
	 		 </div>
	 <div  class="container">
	 	<div class="row">
	 		...
	 		<div class="col-lg-4 col-12 card-second">
	 			<div class="card text-center">
	 				<div class="card-header text-uppercase">Standard</div>
	 				<div class="card-body">
	 		...
	 		<div class="col-lg-4 col-12">
	 			<div class="card text-center">
	 				<div class="card-header text-uppercase">Unlimited</div>
	 				<div class="card-body">
...
<!-- *******************Coustomer Feedback Start************** -->
<section class="happyclients">
	<div class="container heading text-center">
		<h1 class="font-weight-bold text-wh">OUR HAPPY CLIENTS</h1>
...
<section class="contactus mt-5" id="contactid">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 col-10 offset-md-2">
				<form>
  					<div class="form-group">
   						<input type="text" class="form-control" placeholder="Enter Username" id="name" required autocomplete="off">
  					</div>
    				...
    				<div class="form-group">
  					...
  					<div class="form-group">
  						<textarea class="form-control" rows="4" id="comments" placeholder="Comments" required></textarea>
  					</div>
...
<section class="newsletter" id="newsletterid">
	<div class="container heading text-center">
		<h1 class="font-weight-bold">Subcribe our news letter </h1>
	</div>
	<div class="container">
		<div class="row">
			<div class="col-md-8 offset-md-2 col-12">
				<div class="input-group mb-3">
					...
					<div class="input-group-append">
						<span class="input-group-text">Subcribe us</span>
					</div>
				</div>
			</div>
		</div>
